...
class IOHandler:
    ...
    def process_input(self):
        ...
        processes raw inputs and creates a NewEntry object for
        every Cart given by raw_numbers
        '''
        ...
        for cart_number in cart_numbers:
            if cart_number:
                _ = Entry(
                    ...
                    state='done', signatrue=signatrue
                    )
...
class Entry:
    ...
    def __init__(self, cart_number=None, state=None, signatrue=None):
        ...
        # timestamp to see when a cart was completed
        self._timestamp = "{}:{}".format(_.hour, min)
...
class Data:
    ...
    def pull(self):
        ...
        '''
        if (
                os.path.exists(self._file_path) and
                os.stat(self._file_path).st_size > 0
                ):
